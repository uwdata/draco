...
def main():
    with open(absolute_path('weights.lp')) as weight_constants, open(absolute_path('assign_weights.lp'), 'w') as assign, open(absolute_path('../data/weights.json'), 'w') as weights_json:
